...
if (agentWorkflow) {
  ...
  check(
    ...
    "Agent: only the reviewed task, domain-research, and paid LinkedIn lookup tools may be connected",
  );
...
check(
  ...
  "Tool policy must classify the reviewed task, domain-research, and paid LinkedIn lookup tools",
);
check(
  toolPolicy.tools
